...
function sendRequest() {
	...
	jQuery('#contactWrapper').append('<div class="success"><h4>1Email Successfully Sent!</h4><br><p>Thank you for using our contact form <strong>'+decodeURIComponent(name)+'</strong>! Your email was successfully sent and we&#39;ll be in touch with you soon.</p></div>');
	}
}
function sendRequest_booking() {
	...
	jQuery('#contactWrapper').append('<div class="success"><h4>2Email Successfully Sent!</h4><br><p>Thank you for using our contact form <strong>'+decodeURIComponent(name)+'</strong>! Your email was successfully sent and we&#39;ll be in touch with you soon.</p></div>');
	}
}
...
function sendRequest_loans() {
	...
	jQuery('#contactWrapper_popup').append('<div class="success"><h4>3Email Successfully Sent!</h4><br><p>Thank you for using our contact form <strong>'+name+'</strong>! Your email was successfully sent and we&#39;ll be in touch with you soon.</p></div>');
	}
}
...
function sendRequest_popup() {
	...
	jQuery('#contactform_popup').slideUp("slow").hide();
	jQuery('#contactWrapper_popup').append('<div class="success"><h4>4Email Successfully Sent!</h4><br><p>Thank you for using our contact form <strong>'+name+'</strong>! Your email was successfully sent and we&#39;ll be in touch with you soon.</p></div>');
	}
}
