...
<html lang="en">
	...
	<div class="status-content">
		<table>
			...
			<tr><td>In <a class="blue" target="_blank" href="https://steamcommunity.com/groups/<?php echo $steamgroup; ?>">Steam group</a></td><td> <i class="fas fa-<?php echo ($in) ? 'check' :'times';?>"></i></td>
			<tr><td><span class="discord">Discord</span> Linked </td><td><i class="fas fa-<?php echo ($inDiscord) ? 'check' :'times';?>"></i></td>
		</table>
	</div>
	<a class="UnderStatusText"> Redeem rewards in-game with <span>/kit</span></a><br />
	...
	if(!$inDiscord)
	{
		?>
		<div>
			<a href="<?php echo $dicordOAuth2Link; ?>" class="discordlink" target="_blank"><img width="200px" src="./img/discord.png"</a>
		</div>
		<?php
	}
